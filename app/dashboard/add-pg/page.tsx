...
export default function AddPGPage() {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    try {
      ...
      if (data.success) {
        setSuccess("PG listed successfully! You can add another or go back to dashboard.");
        setForm({
          title: "",
          rent: "",
          location: "",
    ...
    <main className="min-h-screen bg-slate-50/50">
      <div className="mx-auto max-w-2xl px-4 py-10 sm:px-6">
        ...
        <div className="rounded-2xl border border-slate-100 bg-white p-8 shadow-sm sm:p-10">
          <h1 className="text-2xl font-bold text-slate-900">List a PG</h1>
          <p className="mt-2 text-slate-600">
            Add a paying guest accommodation near campus. Fill in the details below.
          </p>
          ...
          <form onSubmit={handleSubmit} className="mt-8 space-y-6">
            <div>
              ...
              <input
                ...
                type="text"
                name="title"
                placeholder="e.g. Cozy room near main gate"
                value={form.title}
            ...
            <div>
              ...
              <input
                ...
                type="text"
                name="location"
                placeholder="e.g. Sector 5, near bus stop"
                value={form.location}
                onChange={handleChange}
                className={inputClass}
                required
            ...
            <div>
              <label className={labelClass}>
                Photos (room, kitchen, etc.)
              </label>
              <p className="mb-3 text-sm text-slate-600">
                Add multiple images. First image is the main one.
              </p>
